...
const OurOfferings = () => {
  ...
  <div className="w-full py-5">
      ...
      <div className="mt-8 grid pb-10 md:pb-5 lg:pb-5 grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 w-full px-4 sm:px-6 lg:px-10 items-start">
