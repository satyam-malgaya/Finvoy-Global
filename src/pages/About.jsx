...
const About = () => {
        ...
        <div className="flex flex-col gap-y-5 lg:w-1/2">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-2">
              <FaPlay className="mt-1 text-blue-600" />
  ...
  <div className="bg-white h-[60vh] w-full sm:w-[45%] lg:w-[25%] px-6 text-center border border-gray-50 rounded-lg shadow-xl hover:scale-105 transition-transform duration-300 ">
    ...
    <h1 className="text-2xl font-bold text-blue-700 mt-4">Our Mission</h1>
  ...
  <div className="bg-white h-[60vh] w-full sm:w-[45%] lg:w-[25%] px-6 text-center border border-gray-50 rounded-lg shadow-xl hover:scale-105 transition-transform duration-300">
    ...
    <h1 className="text-2xl font-bold text-blue-700 mt-4">Our Vision</h1>
    <p className="text-gray-700 mt-2">
  ...
  <div className="bg-white h-[60vh] w-full sm:w-[45%] lg:w-[25%] px-6 text-center border border-gray-50 rounded-lg shadow-xl hover:scale-105 transition-transform duration-300">
    ...
    <h1 className="text-2xl font-bold text-blue-700 mt-4">Our Story</h1>
    <p className="text-gray-700 mt-2">
